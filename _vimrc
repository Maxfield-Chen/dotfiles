...
"Map Ctrl-p File finding to ff within directory
map ff :CtrlP<.><cr>
...
" Map <C-L> to put a semicolon at the end of a line.
nnoremap <C-L> $a;<Esc>

"I prefer c-t instead of c-w to move between splits
nnoremap <C-T> <C-W>
...
set guifont=InputMonoNarrow:h10.5:cANSI
